...
describe("Given I am connected as an Admin and I am on Dashboard Page", () => {
  ...
  describe("When a bill has no filename", () => {
    test("Then, it should display invalid file", () => {
      const html = DashboardFormUI(billNoName);
      document.body.innerHTML = html;
      expect(screen.getByText("Invalid file")).toBeTruthy();
    });
  });
});
